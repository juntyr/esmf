# $Id$
#
# Linux.lfortran.default
#

############################################################
# Default compiler setting.
#
ESMF_F90DEFAULT         = lfortran
ESMF_CXXDEFAULT         = g++
ESMF_CDEFAULT           = gcc
...
ifeq ($(ESMF_COMM),lam)
# LAM (assumed to be built with lfortran) -----------------------
...
ESMF_F90COMPILEOPTS = --generate-object-code --no-color
...
ESMF_F90COMPILEFIXCPP    = --cpp --fixed-form #-ffixed-form
...
############################################################
# Determine where lfortran's libraries are located
#
